                    ...
                    <div className="mt-auto pt-2 border-t flex items-center justify-between">
                        ...
                        <div className="flex gap-2 items-center">
                            ...
                            >
                                ...
                                <span className="sr-only">{t('share.twitter', 'Compartir en X/Twitter')}</span>
                            </Button>
                            <Button
                                variant="ghost"
                                size="icon"
                            ...
                            >
                                ...
                                <span className="sr-only">{t('share.facebook', 'Compartir en Facebook')}</span>
                            </Button>
                            <Button
                                variant="ghost"
                                size="icon"
                            ...
                            >
                                ...
                                <span className="sr-only">{t('share.whatsapp', 'Compartir en WhatsApp')}</span>
                            </Button>
                            <Button
                                variant="ghost"
                                size="icon"
